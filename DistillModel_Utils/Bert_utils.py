...
def teacher_validate(model, dataloader):
    """
...
def teacher_test(model, dataloader):
    """
    ...
    return batch_time, total_time, accuracy, roc_auc_score(all_labels, all_prob), teacher_logits

def teacher_train(model, dataloader, optimizer, max_gradient_norm):
    """
    ...
    return epoch_time, epoch_loss, epoch_accuracy, teacher_logits

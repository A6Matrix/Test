...
def pre_processing():
    train_texta, train_textb, train_tag = data_pre.readfile(args.quora_train_path)
    ...
    data_pre.build_vocab(data, args.save_eng_vocab)
...
def load_vocab(texta, textb, tag):
    # 加载词典
    vocab_processor = learn.preprocessing.VocabularyProcessor.restore(args.save_eng_vocab)
...
if __name__ == '__main__':
    ...
    dev_texta, dev_textb, dev_tag = data_pre.readfile(args.quora_dev_path)
    test_texta, test_textb, test_tag = data_pre.readfile(args.quora_test_path)
